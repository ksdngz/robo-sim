...
// char xmlpath[] = "../sample/dbpendulum/doublependulum.xml";
// char xmlpath[] = "../sample/moving_pendulum/movingPendulum.xml";
char xmlpath[] = "../movingPendulum.xml";
//char datapath[] = "../myproject/dbpendulum/data.csv";
// char datapath[] = "../sample/moving_pendulum/data.csv";
