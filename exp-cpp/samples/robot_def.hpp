...
// color code(rgba)
inline const float CLR_RED[4] = {1.f, 0.f, 0.f, 1.f};
inline const float CLR_GREEN[4] = {0.f, 1.f, 0.f, 1.f};
inline const float CLR_BLUE[4] = {0.f, 0.f, 1.f, 1.f};
inline const float CLR_PURPLE[4] = {1.f, 0.f, 1.f, 1.f};
inline const float CLR_YELLOW[4] = {1.f, 1.f, 0.f, 1.f};
